...
public function addRequest(opName:String, opSrc:String, args:Array=null, refObject:Object=null):uint{
	queue.push({opName:opName, opSrc:opSrc, args:args, refObject:refObject});
	pokeQueue();
	return queue.length;
}
